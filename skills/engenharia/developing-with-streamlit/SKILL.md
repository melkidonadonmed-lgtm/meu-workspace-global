...
- NUNCA executar `pip install` globalmente sem ambiente virtual isolado.
- NUNCA usar bibliotecas de terceiros incompatíveis com a versão do Streamlit instalada.
- NUNCA modificar arquivos de configuração sem autorização explícita.
