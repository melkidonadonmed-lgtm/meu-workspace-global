...
- `skills/` — catálogo de skills consumido pelo `skill_parser.py` (progressive disclosure)
...
- Ruff: código vendorado/legado está em `extend-exclude` no `pyproject.toml` (`skills/notebooklm-skill-master`, `inbox`) — não "corrigir" esses diretórios
