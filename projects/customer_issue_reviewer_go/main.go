...
func main() {
	...
	// Caso não haja chave configurada e o usuário não passou subcomandos do launcher,
	// executamos a geração e visualização determinística do relatório com dados simulados.
	if apiKey == "" && len(os.Args) == 1 {
		...
		fmt.Println("Executando análise determinística local dos chamados do cliente...")
		fmt.Println("================================================================================")
		fmt.Println()
